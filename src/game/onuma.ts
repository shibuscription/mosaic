...
const ONUMA_BASE_WEIGHTS: number[][][] = [
  [
    [5, 7, 12, 15, 18, 15, 12, 7, 5],
    [7, 10, 19, 26, 30, 26, 19, 10, 7],
    [12, 19, 37, 40, 43, 40, 37, 19, 12],
    [15, 26, 40, 47, 50, 47, 40, 26, 15],
    [18, 30, 43, 50, 0, 50, 43, 30, 18],
    [15, 26, 40, 47, 50, 47, 40, 26, 15],
    [12, 19, 37, 40, 43, 40, 37, 19, 12],
    [7, 10, 19, 26, 30, 26, 19, 10, 7],
    [5, 7, 12, 15, 18, 15, 12, 7, 5],
  ...
  [
    [6, 8, 10, 12, 12, 10, 8, 6],
    [8, 13, 17, 20, 20, 17, 13, 8],
    [10, 17, 24, 28, 28, 24, 17, 10],
    [12, 20, 28, 38, 38, 28, 20, 12],
    [12, 20, 28, 38, 38, 28, 20, 12],
    [10, 17, 24, 28, 28, 24, 17, 10],
    [8, 13, 17, 20, 20, 17, 13, 8],
    [6, 8, 10, 12, 12, 10, 8, 6],
